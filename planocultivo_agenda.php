...
/**
 *  \file       planocultivo_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on PlanoCultivo
 */
...
if ($object->id > 0) {
	$title = $langs->trans("PlanoCultivo")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("PlanoCultivo"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_planocultivo_'.$object->id;
