...
/**
 *  \file       pragas_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on Pragas
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Pragas")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Pragas"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_pragas_'.$object->id;
