...
ALTER TABLE llx_safra_analisesolo ADD INDEX idx_safra_analisesolo_fk_soc (fk_soc);
...
--ALTER TABLE llx_safra_analisesolo ADD UNIQUE INDEX uk_safra_analisesolo_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_safra_analisesolo ADD CONSTRAINT llx_safra_analisesolo_fk_field FOREIGN KEY (fk_field) REFERENCES llx_safra_myotherobject(rowid);
