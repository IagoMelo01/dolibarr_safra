...
--ALTER TABLE llx_safra_produtostecnicos ADD UNIQUE INDEX uk_safra_produtostecnicos_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_safra_produtostecnicos ADD CONSTRAINT llx_safra_produtostecnicos_fk_field FOREIGN KEY (fk_field) REFERENCES llx_safra_myotherobject(rowid);
