...
ALTER TABLE llx_safra_aplicacao ADD INDEX idx_safra_aplicacao_rowid (rowid);
ALTER TABLE llx_safra_aplicacao ADD INDEX idx_safra_aplicacao_ref (ref);
ALTER TABLE llx_safra_aplicacao ADD INDEX idx_safra_aplicacao_fk_soc (fk_soc);
...
--ALTER TABLE llx_safra_aplicacao ADD CONSTRAINT llx_safra_aplicacao_fk_field FOREIGN KEY (fk_field) REFERENCES llx_safra_myotherobject(rowid);
