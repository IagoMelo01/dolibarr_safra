...
--ALTER TABLE llx_safra_ndvi ADD UNIQUE INDEX uk_safra_ndvi_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_safra_ndvi ADD CONSTRAINT llx_safra_ndvi_fk_field FOREIGN KEY (fk_field) REFERENCES llx_safra_myotherobject(rowid);
