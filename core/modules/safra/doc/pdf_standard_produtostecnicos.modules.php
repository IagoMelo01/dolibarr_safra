...
/**
 *	Class to manage PDF template standard_produtostecnicos
 */
class pdf_standard_produtostecnicos extends ModelePDFProdutosTecnicos
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	ProdutosTecnicos	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('SAFRA_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
