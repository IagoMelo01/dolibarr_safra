...
class modSafra extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->menu[$r++] = array(
			...
			'mainmenu'=>'safra',
			'leftmenu'=>'',
			'url' => '/custom/safra/safraindex.php',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/talhao_list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
			'perms' => '1',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/talhao_card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/cultura_list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/cultura_card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/cultivar_list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/cultivar_card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/pragas_list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/pragas_card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/pragas_produtos.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/produtostecnicos_list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/produtostecnicos_card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/produto_formulado/list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/produto_formulado/card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/municipio_list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/municipio_card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/zoneamento_view.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
			'perms' => '1',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/zoneamento_list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/expectativaprodutividade_list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/expectativaprodutividade_card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/recomendacaoadubo_list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/recomendacaoadubo_card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/evento_list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/evento_card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/colheita_list.php',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/colheita_card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++] = array(
			...
			'url' => '/custom/safra/analisesolo_card.php?action=create',
			'langs' => 'safra@safra',
			'position' => 1000,
			'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++]=array(
			 ...
			 'mainmenu' => 'safra',
			 'leftmenu' => 'janelaplantio',
			 'url' => '/custom/safra/janelaplantio_list.php',
			 'langs' => 'safra@safra',
			 'position' => 1000 + $r,
			 'enabled' => 'isModEnabled(\'safra\')',
			 'perms' => '$user->hasRight(\'safra\', \'janelaplantio\', \'read\')',
		...
		$this->menu[$r++]=array(
			 ...
			 'url' => '/custom/safra/janelaplantio_card.php?action=create',
			 'langs' => 'safra@safra',
			 'position' => 1000 + $r,
			 'enabled' => 'isModEnabled(\'safra\')',
		...
		$this->menu[$r++]=array(
			 ...
			 'url' => '/custom/safra/zoneamento_card.php?action=create',
			 'langs' => 'safra@safra',
			 'position' => 1000 + $r,
			 'enabled' => 'isModEnabled(\'safra\')',
