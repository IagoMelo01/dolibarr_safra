...
/**
 * \file    safra/core/boxes/safrawidget1.php
 * \ingroup safra
 * \brief   Widget provided by Safra
 *
 ...
 */
class safrawidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "safrabox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "safra@safra";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "safra@safra"));
		...
		// $this->hidden = !$user->hasRight('safra', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("SafraBoxDescription", $max);
