...
/**
 *  \file       cultivar_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on Cultivar
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Cultivar")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Cultivar"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_cultivar_'.$object->id;
