...
/**
 *  \file       pragas_note.php
 *  \ingroup    safra
 *  \brief      Tab for notes on Pragas
 */
...
$title = $langs->trans('Pragas').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Pragas"), -1, $object->picto);
