...
/**
 *  \file       ndmi_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on NDMI
 */
...
if ($object->id > 0) {
	$title = $langs->trans("NDMI")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("NDMI"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_ndmi_'.$object->id;
