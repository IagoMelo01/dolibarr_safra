...
class Pragas extends CommonObject
{
	...
	public $fields = array(
		...
		"label" => array("type" => "text", "label" => "Nome Comum", "enabled" => "1", 'position' => 30, 'notnull' => 0, "visible" => "1", "searchall" => "1", "css" => "minwidth300", "cssview" => "wordbreak", "help" => "Help text", "validate" => "1",),
