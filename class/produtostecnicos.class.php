...
class ProdutosTecnicos extends CommonObject
{
	...
	public $fields = array(
		...
		"ref" => array("type" => "varchar(128)", "label" => "Registro", "enabled" => "1", 'position' => 20, 'notnull' => 1, "visible" => "1", "index" => "1", "searchall" => "1", "validate" => "1", "comment" => "Reference of object"),
		"label" => array("type" => "varchar(255)", "label" => "Marca Comercial", "enabled" => "1", 'position' => 30, 'notnull' => 0, "visible" => "1", "searchall" => "1", "css" => "minwidth300", "cssview" => "wordbreak", "help" => "Help text", "validate" => "1",),
		...
		"ingrediente_ativo" => array("type" => "text", "label" => "Ingrediente Ativo", "enabled" => "1", 'position' => 31, 'notnull' => 0, "visible" => "1",),
		"classe" => array("type" => "varchar(128)", "label" => "Classe", "enabled" => "1", 'position' => 32, 'notnull' => 0, "visible" => "1",),
		"titular_registro" => array("type" => "text", "label" => "Titular do registro", "enabled" => "1", 'position' => 33, 'notnull' => 0, "visible" => "1",),
		"classificacao_toxicologica" => array("type" => "varchar(128)", "label" => "Classificação Toxicológica", "enabled" => "1", 'position' => 34, 'notnull' => 0, "visible" => "1",),
		"classificacao_ambiental" => array("type" => "varchar(128)", "label" => "Classificação Ambiental", "enabled" => "1", 'position' => 35, 'notnull' => 0, "visible" => "1",),
	);
	public $rowid;
	public $ref;
	public $label;
	...
	public $classe;
	public $titular_registro;
	public $classificacao_toxicologica;
	public $classificacao_ambiental;
