...
/**
 *  \file       aplicacao_note.php
 *  \ingroup    safra
 *  \brief      Tab for notes on Aplicacao
 */
...
$title = $langs->trans('Aplicacao').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Aplicacao"), -1, $object->picto);
