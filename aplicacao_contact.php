...
/**
 *  \file       aplicacao_contact.php
 *  \ingroup    safra
 *  \brief      Tab for contacts linked to Aplicacao
 */
...
$title = $langs->trans("Aplicacao")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Aplicacao"), -1, $object->picto);
