...
/**
 *  \file       ndwi_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on NDWI
 */
...
if ($object->id > 0) {
	$title = $langs->trans("NDWI")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("NDWI"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_ndwi_'.$object->id;
