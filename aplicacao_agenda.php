...
/**
 *  \file       aplicacao_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on Aplicacao
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Aplicacao")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Aplicacao"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_aplicacao_'.$object->id;
