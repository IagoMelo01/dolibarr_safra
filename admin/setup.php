...
$formSetup->newItem('SAFRA_MYPARAM8')->setAsProduct();
...
$item->helpText = $langs->transnoentities('SAFRA_MYPARAM10');
...
llxHeader('', $langs->trans($page_name), $help_url, '', 0, 0, '', '', '', 'mod-safra page-admin');
