...
/**
 *  \file       janelaplantio_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on JanelaPlantio
 */
...
if ($object->id > 0) {
	$title = $langs->trans("JanelaPlantio")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("JanelaPlantio"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_janelaplantio_'.$object->id;
