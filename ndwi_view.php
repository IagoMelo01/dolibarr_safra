...
if ($selectedTalhaoId > 0) {
    $weeklySeries = SafraSatelliteStatistics::getWeeklySeries($db, $selectedTalhaoId, 'ndwi', 8);
...
$weeklyIndexLabel = $langs->trans('SafraIndexNDWIShort');
...
$chartConfig = array(
    ...
    'options' => array(
        ...
        'rangeFillColor' => 'rgba(2, 132, 199, 0.16)',
        'rangeLineColor' => 'rgba(2, 132, 199, 0.32)',
