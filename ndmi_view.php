...
$mapTips = array(
    'Priorize visitas de campo em áreas avermelhadas durante períodos secos.',
    'Compare o NDMI com o histórico de irrigação para avaliar eficiência hídrica.',
    'Exportar o GeoJSON permite cruzar o índice com mapas de produtividade ou de solo.'
);

$interpretationPoints = array(
    '<strong>Valores negativos</strong> indicam solos muito secos ou pouca cobertura vegetal.',
    '<strong>Entre -0,1 e 0,2</strong> sugere stress hídrico moderado.',
    '<strong>De 0,2 a 0,5</strong> representa umidade adequada ao desenvolvimento da cultura.',
    '<strong>Acima de 0,5</strong> pode sinalizar excesso de água ou saturação do solo.'
);
        ...
        <div class="satellite-layout__main">
            <article class="satellite-card satellite-card--map">
                <div class="satellite-card__header">
                    <h2 class="satellite-card__title">Mapa NDMI</h2>
            ...
            <article class="satellite-card satellite-card--legend">
                ...
                <div class="satellite-legend">
                    <div class="satellite-legend__scale">
                        <div class="satellite-legend__gradient satellite-legend__gradient--ndmi" aria-hidden="true"></div>
                    ...
                    <p class="satellite-legend__caption">Tons quentes indicam solos secos; azuis claros apontam maior disponibilidade de água na vegetação.</p>
                </div>
            </article>
            <article class="satellite-card">
                <h3 class="satellite-card__title">Como interpretar</h3>
                <p>O Índice de Umidade com Diferença Normalizada (NDMI) avalia o conteúdo de água na copa, auxiliando na detecção de stress hídrico e no planejamento de irrigação.</p>
                <ul class="satellite-tips">
                    <?php foreach ($interpretationPoints as $point) {
                        echo '<li>' . $point . '</li>';
                    } ?>
                </ul>
                <a class="satellite-link" href="https://eos.com/make-an-analysis/ndmi/" target="_blank" rel="noopener">Ver guia completo sobre NDMI</a>
            </article>
        </aside>
    </div>
</div>
