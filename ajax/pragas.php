...
/**
 *       \file       htdocs/safra/ajax/pragas.php
 *       \brief      File to return Ajax response on pragas list request
 */
...
// Security check
if (!$user->hasRight('safra', 'pragas', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax safra/ajax/pragas.php");
