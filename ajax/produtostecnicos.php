...
/**
 *       \file       htdocs/safra/ajax/produtostecnicos.php
 *       \brief      File to return Ajax response on produtostecnicos list request
 */
...
// Security check
if (!$user->hasRight('safra', 'produtostecnicos', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax safra/ajax/produtostecnicos.php");
