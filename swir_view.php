...
$mapTips = array(
    'Investigue tons alaranjados para localizar áreas queimadas ou solos muito secos.',
    'Compare o SWIR com NDVI e NDMI para entender impactos de stress hídrico.',
    'Utilize o GeoJSON em análises geológicas ou para mapear cicatrizes de fogo.'
);

$interpretationPoints = array(
    '<strong>Tons escuros</strong> representam água, sombra ou superfícies frias.',
    '<strong>Verdes a amarelos</strong> indicam vegetação e solos úmidos.',
    '<strong>Laranjas e vermelhos</strong> destacam solos expostos, estresse térmico ou áreas queimadas.',
    '<strong>Tons muito claros</strong> podem sinalizar salinização ou superfícies artificiais.'
);
        ...
        <div class="satellite-layout__main">
            <article class="satellite-card satellite-card--map">
                <div class="satellite-card__header">
                    <h2 class="satellite-card__title">Mapa SWIR</h2>
                    <p class="satellite-card__subtitle" id="selectionTitle">Escolha um talhão e um período para analisar o compósito.</p>
                </div>
            ...
            <article class="satellite-card satellite-card--legend">
                ...
                <div class="satellite-legend">
                    <div class="satellite-legend__scale">
                        <div class="satellite-legend__gradient satellite-legend__gradient--swir" aria-hidden="true"></div>
                        <ul class="satellite-legend__ticks satellite-legend__ticks--text">
                            <li>Água / sombra</li>
                            <li>Vegetação úmida</li>
                            <li>Solo exposto</li>
                            <li>Queimadas ou materiais quentes</li>
                        </ul>
                    </div>
                    <p class="satellite-legend__caption">O compósito SWIR evidencia água escura, vegetação úmida em verdes e áreas quentes em tons alaranjados.</p>
                </div>
            </article>
            <article class="satellite-card">
                <h3 class="satellite-card__title">Como interpretar</h3>
                <p>O compósito SWIR combina bandas de infravermelho de onda curta para destacar umidade, queimadas e características geológicas com alta precisão espacial.</p>
                <ul class="satellite-tips">
                    <?php foreach ($interpretationPoints as $point) {
                        echo '<li>' . $point . '</li>';
                    } ?>
                </ul>
                <a class="satellite-link" href="https://custom-scripts.sentinel-hub.com/custom-scripts/sentinel-2/swir/" target="_blank" rel="noopener">Ver guia completo sobre SWIR</a>
            </article>
        </aside>
    </div>
</div>
