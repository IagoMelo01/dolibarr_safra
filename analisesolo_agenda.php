...
/**
 *  \file       analisesolo_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on AnaliseSolo
 */
...
if ($object->id > 0) {
	$title = $langs->trans("AnaliseSolo")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("AnaliseSolo"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_analisesolo_'.$object->id;
