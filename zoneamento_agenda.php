...
/**
 *  \file       zoneamento_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on Zoneamento
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Zoneamento")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Zoneamento"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_zoneamento_'.$object->id;
