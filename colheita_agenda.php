...
/**
 *  \file       colheita_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on Colheita
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Colheita")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Colheita"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_colheita_'.$object->id;
