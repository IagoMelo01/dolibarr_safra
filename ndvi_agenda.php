...
/**
 *  \file       ndvi_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on NDVI
 */
...
if ($object->id > 0) {
	$title = $langs->trans("NDVI")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("NDVI"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_ndvi_'.$object->id;
