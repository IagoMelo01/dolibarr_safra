...
/**
 *  \file       swir_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on SWIR
 */
...
if ($object->id > 0) {
	$title = $langs->trans("SWIR")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("SWIR"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_swir_'.$object->id;
