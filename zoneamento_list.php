...
/**
 *   	\file       zoneamento_list.php
 *		\ingroup    safra
 *		\brief      List page for zoneamento
 */
...
require_once __DIR__.'/class/zoneamento.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('safra', 'zoneamento', 'write');
	$permissiontodelete = $user->hasRight('safra', 'zoneamento', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Zoneamento';
	$objectlabel = 'Zoneamento';
...
$title = $langs->trans("Zoneamentos");
//$help_url = "EN:Module_Zoneamento|FR:Module_Zoneamento_FR|ES:Módulo_Zoneamento";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/safra/zoneamento_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('ZoneamentoPlantingWindowsButton'), '', 'fa fa-calendar', dol_buildpath('/safra/zoneamento_windows.php', 1), '', 1, array('morecss' => 'reposition'));
$newcardbutton .= dolGetButtonTitleSeparator();
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/safra/zoneamento_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendZoneamentoRef";
$modelmail = "zoneamento";
$objecttmp = new Zoneamento($db);
