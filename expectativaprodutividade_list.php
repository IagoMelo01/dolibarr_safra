...
/**
 *   	\file       expectativaprodutividade_list.php
 *		\ingroup    safra
 *		\brief      List page for expectativaprodutividade
 */
...
require_once __DIR__.'/class/expectativaprodutividade.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('safra', 'expectativaprodutividade', 'write');
	$permissiontodelete = $user->hasRight('safra', 'expectativaprodutividade', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'ExpectativaProdutividade';
	$objectlabel = 'ExpectativaProdutividade';
...
$title = $langs->trans("ExpectativaProdutividades");
//$help_url = "EN:Module_ExpectativaProdutividade|FR:Module_ExpectativaProdutividade_FR|ES:Módulo_ExpectativaProdutividade";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/safra/expectativaprodutividade_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/safra/expectativaprodutividade_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendExpectativaProdutividadeRef";
$modelmail = "expectativaprodutividade";
$objecttmp = new ExpectativaProdutividade($db);
