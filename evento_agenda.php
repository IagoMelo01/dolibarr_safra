...
/**
 *  \file       evento_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on Evento
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Evento")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Evento"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_evento_'.$object->id;
